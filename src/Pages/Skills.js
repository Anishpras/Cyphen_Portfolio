    ...
    <div className="skill">
      ...
      <div className="skill_mid">
        <div className="skill_content">
          ...
          <h4>We also have full-stack developer experience.</h4>
        </div>
        <div className="skill_svg">
            <iframe cla src="https://stupefied-ardinghelli-d53e3a.netlify.app/" frameborder="0"></iframe>
        </div>
      </div>
